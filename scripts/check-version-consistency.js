...
const packageManifests = [
  ...
  ['create-zx-vibes', 'packages/create-zx-vibes/package.json'],
  ['@zx-vibes/toolkit', 'packages/toolkit/package.json'],
  ['@zx-vibes/asm', 'packages/asm/package.json'],
  ['@zx-vibes/emulator', 'packages/emulator/package.json'],
];
...
for (const file of [
  ...
  'packages/create-zx-vibes/starters/game/package.json',
  'packages/create-zx-vibes/starters/platformer/package.json',
  'packages/toolkit/templates/game/package.json',
  'packages/toolkit/templates/platformer/package.json',
]) {
...
for (const file of [
  'packages/create-zx-vibes/README.md',
  'docs/manual/create-project.md',
  'packages/create-zx-vibes/docs/manual/create-project.md',
]) {
  updateText(file, (text) => replaceStarterRangeMention(text));
}
